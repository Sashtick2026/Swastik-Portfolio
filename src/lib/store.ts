...
const INITIAL_DATA: PortfolioData = {
  ...
  testimonials: [
    ...
    },
    {
      ...
      role: "Lead Engineer",
      company: "TechSphere",
      text: "Outstanding attention to detail. The interactions are buttery smooth, and the code quality is exceptional.",
      rating: 5,
    ...
    },
    {
      ...
      text: "One of the best web designers I've ever worked with. His aesthetic sense is brilliant, and his communication was solid throughout.",
      rating: 5,
